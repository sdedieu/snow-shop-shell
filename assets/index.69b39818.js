...
plugins: [
  ...
  sharedMappings.getPlugin()
        ...
        </pre></div></div>`,2),_s=[ls];function ms(n,o,i,c,s,t){return a(),d("div",rs,_s)}var ps=r(ds,[["render",ms]]),us="/snow-shop-slides/assets/vue-logo.32e41e2e.png";const vs={name:"VueDemoCover"},hs={class:"slide-content"},fs=e("div",{class:"slide-title"},[e("h5",null,"EXEMPLE AVEC VUE")],-1),gs=e("div",{class:"cover-container"},[e("img",{src:us,alt:""})],-1),$s=[fs,gs];function xs(n,o,i,c,s,t){return a(),d("div",hs,$s)}var ws=r(vs,[["render",xs]]);const bs={name:"VueDemo"},Es={id:"vue-demo"},As={id:"cover"},Cs={id:"code-native-element"},Ms={id:"code-host-router"},Rs={id:"code-host-wrapper"};function ys(n,o,i,c,s,t){const _=ws,m=ps,u=as,v=ss;return a(),d("section",Es,[e("section",As,[l(_)]),e("section",Cs,[l(m)]),e("section",Ms,[l(u)]),e("section",Rs,[l(v)])])}var Is=r(bs,[["render",ys]]);const Ss={name:"AngularDemoCode"},js={class:"slide-content"},Bs=p(`<div class="slide-title"><h5>ADAPTATION DU ROUTER</h5></div><div class="code-col-grid"><div class="code-col"><div class="text-base"># app-routing.module.ts</div><pre>        <code class="js">
const routes: Routes = [
  // Others routes goes there
  { 
    path:&#39;mfe&#39;, 
